    ...
    function rowSaveData(button, product_id) {
        ...
        let newRowProduct = `
            <tr class="order1763 baseProductId8750 transition display"><th scope="row">1763</th><td id="name8750"> رشته آشی پرهامfeafe</td><td id="count8750">6</td><td id="price8750">0.00</td><td style="color:red" class="status1763">              <button class="btn btn-default" onclick="acceptOneOrder(962,this,event,3354)" style="background:green;color:white;" data-orderid="1763">قبول</button>
                <!-- <button class="btn btn-default" onclick="rejectOrder(962,this,event)" style="background:red;color:white;" data-orderId="1763">رد</button> -->
                <!-- Trigger the modal with a button -->
                <!-- <button type="button" class="btn btn-warning btn" data-toggle="modal" data-target="#myModal">Open Modal</button> -->
                <button type="button" class="btn btn-warning btn" onclick="clickModal(962,1763,8750)">تغییر محصول</button>
            </td></tr> `;

        //insert into base table or orderTable
        let nameTd = document.querySelector(('#name' + newRowData.baseProduct_id));
        let countTd = document.querySelector(('#count' + newRowData.baseProduct_id));
        let priceTd = document.querySelector(('#price' + newRowData.baseProduct_id));

        nameTd.innerHTML = newRowData.name;
        countTd.innerHTML = newRowData.count;
        priceTd.innerHTML = newRowData.price;
    ...
    function saveData() {
        //insert into dom
        saveDom(nameValue, countValue, priceValue);
    ...
    //save into dom
    function saveDom(nameValue, countValue, priceValue) {
        newRowData.name = nameValue ? nameValue : oldRowData.name;
        newRowData.count = countValue ? countValue : oldRowData.count;
        newRowData.price = priceValue ? priceValue : oldRowData.price;
